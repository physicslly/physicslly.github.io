...
- **Two‑point function** \(\langle \mathcal{O}_{i}(x) \mathcal{O}_{j}(0) \rangle = \frac{\delta_{ij}}{|x|^{2\Delta_{i}}}\).
- **Three‑point function** \(\langle \mathcal{O}_{i}(x_{1}) \mathcal{O}_{j}(x_{2}) \mathcal{O}_{k}(x_{3}) \rangle = \frac{C_{ijk}}{|x_{12}|^{\Delta_{i}+\Delta_{j}-\Delta_{k}}|x_{23}|^{\Delta_{j}+\Delta_{k}-\Delta_{i}}|x_{13}|^{\Delta_{k}+\Delta_{i}-\Delta_{j}}}\),
